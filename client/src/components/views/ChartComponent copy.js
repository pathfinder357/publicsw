    ...
    return (
        <div>
          ...
          <div style={{ height: 100 }}>
              <Row gutter={[16, 16]}>
                  <Col lg={24} xs={24}>
                      {/* <RadioBox list={compare } /> */}
                      <RadioBox list={comparecolumn} handleCompares ={comparecolumn => handleCompares(comparecolumn)} />
                  </Col>
              </Row>
          </div>
          <div style={{ height: 600 }}>
              {/* <Key_77_compare data = {compare} /> */}
              <NivoLine_compare data = {comparedata} />
          </div>
          <br/>
          <br/>
          <div>
              <p>"key_77" Compare data</p>
              <p>mindate : {mindate} maxdate : {maxdate}</p>
              <p>{startDate.toDateString()} ~ {endDate.toDateString()}</p>
